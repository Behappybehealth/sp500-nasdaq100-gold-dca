...
# File structure: 666 lines, well-organized with clear section headers:
#     - L1-18: Module docstring
#     - L32-53: Imports + logger
#     - L56-102: Exceptions + field constants
#     - L105-140: Schema helpers + PIN constants
#     - L143-180: Backend detection + connection
#     - L183-256: Sheet low-level read/write (with cache, backup)
#     - L259-473: User/PIN auth logic (~210 lines)
#     - L476-574: Data CRUD
#     - L577-647: Cloud→local sync
#     - L650-666: Local path helpers
